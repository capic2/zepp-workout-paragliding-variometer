...
const ui_1 = require("@zos/ui");
const app_access_1 = require("@zos/app-access");
const sensor_1 = require("@zos/sensor");
const display_1 = require("@zos/display");
const media_1 = require("@zos/media");
const globalNativePlayer = (0, media_1.create)(media_1.id.PLAYER);
DataWidget({
    state: {
    ...
    build() {
        ...
        try {
            (0, display_1.pauseDropWristScreenOff)({ duration: 0 });
            (0, display_1.pausePalmScreenOff)({ duration: 0 });
            (0, display_1.setWakeUpRelaunch)({ relaunch: true });
            console.log("[build] Screen will stay ON");
        }
        catch (error) {
            console.log(`[build] Screen error: ${error}`);
        }
        (0, ui_1.createWidget)(ui_1.widget.FILL_RECT, {
            x: 0,
            y: 0,
            w: 480,
            h: 480,
        ...
        this.state.leftBar = (0, ui_1.createWidget)(ui_1.widget.FILL_RECT, {
            x: 0,
            y: 0,
            w: 60,
            h: 480,
        ...
        this.state.rightBar = (0, ui_1.createWidget)(ui_1.widget.FILL_RECT, {
            x: 420,
            y: 0,
            w: 60,
            h: 480,
        ...
        this.state.flightStateIndicator = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 0,
            y: 25,
            w: 480,
            h: 30,
            ...
            text_size: 18,
            color: 0xffff00,
            align_h: ui_1.align.CENTER_H,
        });
        this.state.flightDurationWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 0,
            y: 55,
            w: 480,
            h: 28,
        ...
        this.state.altitudeWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 70,
            y: 95,
            w: 85,
            h: 80,
            ...
            color: 0xffffff,
            align_h: ui_1.align.CENTER_H,
            align_v: ui_1.align.CENTER_V,
        });
        (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            text: "m",
            x: 70,
            y: 170,
            w: 85,
        ...
        this.state.gainWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 325,
            y: 117,
            w: 85,
            h: 35,
        ...
        this.state.maxAltWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 325,
            y: 168,
            w: 85,
            h: 28,
        ...
        this.state.thermalIndicator = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 160,
            y: 90,
            w: 160,
            h: 55,
            ...
            color: 0x00ff00,
            align_h: ui_1.align.CENTER_H,
            text_style: ui_1.text_style.WRAP,
        });
        this.state.chevrons = [];
        for (let i = 0; i < 3; i++) {
            this.state.chevrons.push((0, ui_1.createWidget)(ui_1.widget.IMG, {
                x: 220,
                y: 150 + i * 30,
                w: 40,
                h: 40,
        ...
        this.state.vSpeedWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            text: "---",
            x: 0,
            y: 250,
            w: 480,
        ...
        this.state.thermalCountWidget = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 205,
            y: 360,
            w: 110,
            h: 28,
            ...
            text_size: 15,
            color: 0xcccccc,
            align_h: ui_1.align.LEFT,
        });
        (0, ui_1.createWidget)(ui_1.widget.SPORT_DATA, {
            edit_id: 2,
            category: ui_1.edit_widget_group_type.SPORTS,
            default_type: ui_1.sport_data.SPEED,
            x: 80,
            y: 395,
            w: 150,
            h: 45,
        ...
        (0, ui_1.createWidget)(ui_1.widget.SPORT_DATA, {
            edit_id: 3,
            category: ui_1.edit_widget_group_type.SPORTS,
            default_type: ui_1.sport_data.DISTANCE_TOTAL,
            x: 250,
            y: 395,
            w: 150,
            h: 45,
        ...
        const touchArea = (0, ui_1.createWidget)(ui_1.widget.FILL_RECT, {
            x: 0,
            y: 0,
            w: 480,
            h: 480,
        ...
        touchArea.addEventListener(ui_1.event.CLICK_DOWN, () => {
            touchStartTime = Date.now();
            console.log("[Touch] Down");
        });
        touchArea.addEventListener(ui_1.event.CLICK_UP, () => {
    ...
    buildTestPanel() {
        this.state.testPanel = (0, ui_1.createWidget)(ui_1.widget.FILL_RECT, {
            x: 0,
            y: 0,
            w: 480,
            h: 480,
        ...
        this.state.testPanel.setProperty(ui_1.prop.VISIBLE, false);
        this.state.testTitle = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 0,
            y: 30,
            w: 480,
            h: 40,
        ...
        this.state.testTitle.setProperty(ui_1.prop.VISIBLE, false);
        this.state.testInstruction = (0, ui_1.createWidget)(ui_1.widget.TEXT, {
            x: 0,
            y: 420,
            w: 480,
            h: 30,
        ...
        this.state.testInstruction.setProperty(ui_1.prop.VISIBLE, false);
        // Bouton CLIMB +2m/s
        this.state.testButtonClimb = (0, ui_1.createWidget)(ui_1.widget.BUTTON, {
            x: 40,
            y: 100,
            w: 180,
            h: 80,
        ...
        this.state.testButtonClimb.setProperty(ui_1.prop.VISIBLE, false);
        // Bouton SINK -2m/s
        this.state.testButtonSink = (0, ui_1.createWidget)(ui_1.widget.BUTTON, {
            x: 260,
            y: 100,
            w: 180,
            h: 80,
        ...
        this.state.testButtonSink.setProperty(ui_1.prop.VISIBLE, false);
        // Bouton TEST SOUND
        this.state.testButtonSound = (0, ui_1.createWidget)(ui_1.widget.BUTTON, {
            x: 40,
            y: 200,
            w: 180,
            h: 80,
        ...
        this.state.testButtonSound.setProperty(ui_1.prop.VISIBLE, false);
        // Bouton TEST VIBRATION
        this.state.testButtonVibration = (0, ui_1.createWidget)(ui_1.widget.BUTTON, {
            x: 260,
            y: 200,
            w: 180,
            h: 80,
        ...
        this.state.testButtonVibration.setProperty(ui_1.prop.VISIBLE, false);
        // Bouton RESET
        this.state.testButtonReset = (0, ui_1.createWidget)(ui_1.widget.BUTTON, {
            x: 140,
            y: 300,
            w: 200,
            h: 60,
        ...
        this.state.testButtonReset.setProperty(ui_1.prop.VISIBLE, false);
    },
    enterTestMode() {
        if (this.state.isTestMode)
            return; // garde contre les appels multiples
        this.state.isTestMode = true;
        this.state.testVSpeed = 0;
        this.state.testPanel.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testTitle.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testInstruction.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testButtonClimb.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testButtonSink.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testButtonSound.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testButtonVibration.setProperty(ui_1.prop.VISIBLE, true);
        this.state.testButtonReset.setProperty(ui_1.prop.VISIBLE, true);
        // Les listeners ne sont enregistrés qu'une seule fois (lors du premier appel)
        if (!this.state._testPanelListenersAdded) {
            let touchStartTime = 0;
            this.state.testPanel.addEventListener(ui_1.event.CLICK_DOWN, () => {
                touchStartTime = Date.now();
                console.log("[TEST] Panel touch down");
            });
            this.state.testPanel.addEventListener(ui_1.event.CLICK_UP, () => {
                const touchDuration = Date.now() - touchStartTime;
    ...
    testVSpeed(vSpeed) {
        ...
        if (this.state.vSpeedWidget) {
            this.state.vSpeedWidget.setProperty(ui_1.prop.MORE, {
    ...
    initNativeAudioPlayer() {
        try {
            ...
            globalNativePlayer.addEventListener(globalNativePlayer.event.PREPARE, (result) => {
                if (result) {
            ...
            globalNativePlayer.addEventListener(globalNativePlayer.event.COMPLETE, () => {
            ...
            globalNativePlayer.addEventListener(globalNativePlayer.event.PLAY, (result) => {
                if (result) {
                    console.log("[NativeAudio] ✅ PLAY started successfully");
                }
                else {
                    console.log("[NativeAudio] ❌ PLAY failed (start() returned false)");
                }
            });
            globalNativePlayer.addEventListener(globalNativePlayer.event.ERROR, (error) => {
    ...
    initVibrator() {
        try {
            ...
            this.state.vibrator = new sensor_1.Vibrator();
    ...
    initAccelerometer() {
        try {
            ...
            this.state.accelerometer = new sensor_1.Accelerometer();
    ...
    detectAndStart() {
        ...
        const testResult = (0, app_access_1.getSportData)({ type: "vertical_speed" }, (callbackResult) => {
    ...
    fetchRealData() {
        (0, app_access_1.getSportData)({ type: "vertical_speed" }, (callbackResult) => {
            if (callbackResult.code === 0) {
                try {
                    const parsed = JSON.parse(callbackResult.data);
                    if (parsed && parsed[0] && parsed[0].vertical_speed !== undefined) {
                        const vSpeedMeterPerHour = parseFloat(String(parsed[0].vertical_speed));
        ...
        (0, app_access_1.getSportData)({ type: "altitude" }, (callbackResult) => {
            if (callbackResult.code === 0) {
                try {
                    const parsed = JSON.parse(callbackResult.data);
        ...
        (0, app_access_1.getSportData)({ type: "speed" }, (callbackResult) => {
            if (callbackResult.code === 0) {
                try {
                    const parsed = JSON.parse(callbackResult.data);
    ...
    updateAltitudeDisplay() {
        if (!this.state.altitudeWidget)
            return;
        const alt = Math.round(this.state.currentAltitude);
        this.state.altitudeWidget.setProperty(ui_1.prop.MORE, {
            text: alt.toString(),
        });
        if (this.state.flightState === "FLYING") {
            ...
            if (this.state.gainWidget) {
                ...
                this.state.gainWidget.setProperty(ui_1.prop.MORE, {
                    text: `${gain >= 0 ? "+" : ""}${Math.round(gain)}m`,
                    color: gainColor,
                });
            }
            if (this.state.maxAltWidget) {
                this.state.maxAltWidget.setProperty(ui_1.prop.MORE, {
    ...
    detectFlightState() {
        ...
        if (this.state.flightState === "WAITING") {
            ...
            if (isRunning || (isClimbing && hasGainedAlt)) {
                console.log(`[FlightState] 🚀 TAKEOFF! Speed:${gSpeed.toFixed(1)}km/h VSpeed:${vSpeed.toFixed(1)}m/s Gain:${altGain.toFixed(1)}m`);
                ...
                if (this.state.flightStateIndicator) {
                    this.state.flightStateIndicator.setProperty(ui_1.prop.MORE, {
                        text: "✈️ FLYING",
                        color: 0x00ff00,
                    });
                }
            ...
            const isNotClimbing = Math.abs(vSpeed) < this.config.landing.maxVerticalSpeed;
            if (isSlowSpeed && isNotClimbing) {
                if (!this.state.landingDetectionStartTime) {
                    ...
                    const altChange = Math.abs(currentAlt - this.state.landingDetectionAltitude);
                    if (detectionDuration > this.config.landing.confirmationTime &&
                        altChange < this.config.landing.maxAltitudeChange) {
                        console.log(`[FlightState] 🛬 LANDED! ${(detectionDuration / 1000).toFixed(0)}s on ground`);
                        this.state.flightState = "LANDED";
                        if (this.state.vibrator) {
                            this.executeVibrationPattern(this.config.vibration.patterns.landing);
                        }
                        if (this.state.flightStateIndicator) {
                            this.state.flightStateIndicator.setProperty(ui_1.prop.MORE, {
                                text: "🛬 LANDED",
    ...
    flashTakeoff() {
        ...
        const flashInterval = setInterval(() => {
            ...
            if (this.state.leftBar && this.state.rightBar) {
                ...
                this.state.leftBar.setProperty(ui_1.prop.MORE, { color: color });
                this.state.rightBar.setProperty(ui_1.prop.MORE, { color: color });
            }
            flashCount++;
        }, 150);
    },
    updateFlightDuration() {
        ...
        this.state.flightDurationWidget.setProperty(ui_1.prop.MORE, {
    ...
    detectThermal(vSpeed) {
        ...
        if (!this.state.inThermal) {
            ...
            if (vSpeed < this.config.thermal.exitClimbRate) {
                ...
                console.log(`[Thermal] ❌ EXITING - ${(duration / 1000).toFixed(1)}s, +${altitudeGain.toFixed(0)}m`);
                ...
                this.state.currentThermal.maxClimbRate = Math.max(this.state.currentThermal.maxClimbRate, vSpeed);
            }
        }
        this.updateThermalIndicator();
    },
    updateThermalIndicator() {
        if (!this.state.thermalIndicator)
            return;
        if (this.state.inThermal) {
            ...
            this.state.thermalIndicator.setProperty(ui_1.prop.MORE, {
    ...
    updateThermalCount() {
        if (!this.state.thermalCountWidget)
            return;
        ...
        const text = count === 0
            ...
            : count === 1
                ? "1 thermal"
                : `${count} thermals`;
        this.state.thermalCountWidget.setProperty(ui_1.prop.MORE, {
            text: text,
        });
    },
    flashThermalEntry() {
    ...
    updateChevrons(vSpeed) {
        ...
        if (vSpeed > this.config.deadband) {
            ...
            this.state.chevrons.forEach((chevron, i) => {
                chevron.setProperty(ui_1.prop.MORE, {
                    src: "chevron_up.png",
    ...
    updateAnimations() {
        ...
        if (this.state.chevrons && Math.abs(vSpeed) > this.config.deadband) {
            ...
            this.state.chevrons.forEach((chevron, i) => {
                let baseY = 150 + i * 30;
                if (vSpeed > this.config.deadband) {
                    chevron.setProperty(ui_1.prop.MORE, { y: baseY - Math.abs(offset) });
                }
                else if (vSpeed < -this.config.deadband) {
                    chevron.setProperty(ui_1.prop.MORE, { y: baseY + Math.abs(offset) });
                }
        ...
        if (this.state.leftBar && this.state.rightBar) {
            ...
            this.state.leftBar.setProperty(ui_1.prop.MORE, {
                color: barColor,
                h: barHeight,
                y: barY,
            });
            this.state.rightBar.setProperty(ui_1.prop.MORE, {
                color: barColor,
                h: barHeight,
                y: barY,
            });
    ...
    onDestroy() {
        ...
        try {
            (0, display_1.pauseDropWristScreenOff)({ duration: 1 });
            (0, display_1.pausePalmScreenOff)({ duration: 1 });
        }
        catch (error) {
